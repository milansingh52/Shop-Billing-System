...
public class AdminBilling extends javax.swing.JFrame {
    ...
    public AdminBilling(String name) {
        initComponents();
        curDateTime();
    ...
    private void initComponents() {
        ...
        product_name_jTextField = new javax.swing.JTextField();
        ...
        product_name_jTextField.setEditable(false);
        product_name_jTextField.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPanel2.add(product_name_jTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 180, 30));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/1billing background.png"))); // NOI18N
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 10, 260, 50));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1340, 0, 20, 40));

        jLabel7.setFont(new java.awt.Font("Bookman Old Style", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Shop Billing System");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 270, 40));
    ...
    private void add_to_cart_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_to_cart_btnActionPerformed
        ...
        String item_name = product_name_jTextField.getText();
...
//        welcome_emp_name_jLabel3.setText("Welcome, Admin");
        add_to_cart_btn.setEnabled(false);
...
//            -----> We make number to word 
            ...
            Paragraph paragraph0 = new Paragraph("\nBill by: Admin",FontFactory.getFont(FontFactory.COURIER_BOLD,14));
...
//*******************************referesh Part************************************
        if(flag==true)
        {
            new AdminBilling(employee_name).setVisible(true);
            this.dispose();
    ...
    private javax.swing.JTextField product_name_jTextField;
