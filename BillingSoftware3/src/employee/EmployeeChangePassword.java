...
public class EmployeeChangePassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 120, 119, 32));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(51, 51, 255));
        jLabel2.setText("New Password");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 170, 119, 32));
        ...
        jPanel2.add(old_passwordjTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 120, 286, 40));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, 190, 40));

        new_password.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jPanel2.add(new_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 170, 286, 40));

        confirm_password.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jPanel2.add(confirm_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, 286, 40));
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 570, 60));
        jPanel2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 600, 10));
        jPanel2.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 600, 10));
        ...
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 10, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
            ...
            if(rs!=null)
            {
                int i = DbOperation.employeeUpdatePassword(new_pass, old_pass);
                if(i>0){
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Password didn't Changed due some error", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
