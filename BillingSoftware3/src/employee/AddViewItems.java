...
public class AddViewItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(add_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 570, 110, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddViewItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
